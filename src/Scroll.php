...
class Scroll
{
    ...
    public  static function icon($library,$icon, $options = [])
    {
        $options = self::getOptions($options);
//        $classes = self::buildIconClasses($icon, (isset($options['class']) ? $options['class'] : ''));
//        dd($classes);
//        $attributes = self::buildAttributes($options, $classes);
        return self::buildIcon($library,$icon,$options);
    }
    /**
     ...
     * @return string
     */
    public static  function buildIconClasses($icon, $extraClasses)
    {
        return $extraClasses != '' ? $extraClasses : '';
//        return self::getIcon($icon).($extraClasses != '' ? ' '.$extraClasses : '');
    }
    /**
     ...
     * @return string
     */
    public static  function buildAttributes($options, $classes)
    {
        $attributes = [];
        ...
        if (is_array($options)) {
            foreach ($options as $attribute => $value) {
                $attributes[] = self::createAttribute($attribute, $value);
            }
        }
     ...
     * @return string
     */
    public static  function buildIcon($library,$icon,$attributes)
    {
